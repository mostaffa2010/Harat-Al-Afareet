 ...
 * In-Game HUD (Star Level Badge, Zero Dash, Reliable Pause Button)
 */
...
export class HUD {
            ...
            <div class="game-hud">
                <div class="hud-top-section">
                    <div class="hud-top-bar">
                        <!-- Upward Level Badge with Star Icon ⭐ -->
                        ...
                        <div class="hud-bars-container">
                            <div class="bar-wrapper hp-bar-wrapper">
                                ...
                                <span class="bar-text hp-bar-text" id="hud-hp-text">
                                    <span class="bidi-val" id="hud-hp-num">190 / 190</span>
                                    <span>❤️</span>
                                </span>
                            </div>
                        ...
                        <!-- Meta Group & Reliable Pause Button -->
                        <div class="hud-meta-group">
                            ...
                            <button class="hud-btn hud-pause-btn interactive" id="hud-btn-pause" type="button" aria-label="إيقاف مؤقت">⏸</button>
                        </div>
                    </div>
                ...
                <!-- Bottom Bar: Active Weapons Only (Zero Dash Button) -->
    ...
    bindEvents() {
        ...
        if (pauseBtn) {
            ...
            pauseBtn.onclick = triggerPause;
            pauseBtn.ontouchstart = triggerPause;
        }
    }
            ...
            wepList.innerHTML = player.weapons.map(w => {
                ...
                return `
                    <div class="weapon-slot ${isMax ? 'weapon-slot-evolved' : ''}" title="${w.name}">
                        ...
                        <span class="weapon-lvl">${isMax ? '⭐ أسطورة' : `مستوى ${w.level}`}</span>
                    </div>
                `;
            }).join('');
        }
